...
def main():
    ...
    file_path=unicode(results_saving_path+'cds_global_results.csv','utf-8')
    f=open(file_path, 'w')
    ...
    my_magasin_request = "select distinct cds_nb_distinct_magasin, count(*) from CATALOG where cds_nb_distinct_magasin is not null group by cds_nb_distinct_magasin order by cds_nb_distinct_magasin  asc"
    ...
    my_state_request = "select distinct cds_nb_distinct_state, count(*) from CATALOG where cds_nb_distinct_state is not null group by cds_nb_distinct_state order by cds_nb_distinct_state  asc"
    ...
    my_cat4_request = "select distinct cds_nb_distinct_cat4, count(*) from CATALOG where cds_nb_distinct_cat4 is not null group by cds_nb_distinct_cat4 order by cds_nb_distinct_cat4  asc"
    ...
    for magasin_to_loop in my_magasins:
        ...
        my_brand_request = "select distinct cds_nb_distinct_brand, count(*) from CATALOG where cds_nb_distinct_brand is not null and magasin=(%s) group by cds_nb_distinct_brand order by cds_nb_distinct_brand asc"
        current_parameter_checked="distinct_brand" 
        ...
        my_magasin_request = "select distinct cds_nb_distinct_magasin, count(*) from CATALOG where cds_nb_distinct_magasin is not null and magasin=(%s) group by cds_nb_distinct_magasin order by cds_nb_distinct_magasin asc"
        current_parameter_checked="distinct_magasin" 
        print "Dealing with :"+current_parameter_checked
        ...
        #y= np.asanyarray(y);
        save_histogram_to_existing_csv_file(f, current_parameter_checked, magasin_to_display,X)
        my_state_request = "select distinct cds_nb_distinct_state, count(*) from CATALOG where cds_nb_distinct_state is not null and magasin=(%s) group by cds_nb_distinct_state order by cds_nb_distinct_state asc"
        current_parameter_checked="distinct_state" 
        print "Dealing with :"+current_parameter_checked
        ...
        my_cat4_request = "select distinct cds_nb_distinct_cat4, count(*) from CATALOG where cds_nb_distinct_cat4 is not null and magasin=(%s) group by cds_nb_distinct_cat4 order by cds_nb_distinct_cat4 asc"
